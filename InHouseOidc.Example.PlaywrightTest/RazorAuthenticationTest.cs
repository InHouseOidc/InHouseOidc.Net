...
{
    /// <summary>
    /// Authentication tests for InHouseOidc.Example.Razor (http://localhost:5101).
    /// </summary>
    [TestClass]
    public partial class RazorAuthenticationTest : AuthenticationTestBase
    {
        ...
        public async Task Authentication()
        {
            ...
            await this.Page.GotoAsync("http://localhost:5101/");
            ...
            await this.Page.WaitForURLAsync("http://localhost:5101/");
            ...
            await this.Page.ClickAsync("#callProviderApi");
            var providerApiResult = this.Page.Locator("form:has(#callProviderApi) + span");
            await this.Expect(providerApiResult).ToContainTextAsync("/secure response:");
