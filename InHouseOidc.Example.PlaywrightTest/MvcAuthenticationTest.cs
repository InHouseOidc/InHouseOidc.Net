...
{
    /// <summary>
    /// Authentication tests for InHouseOidc.Example.Mvc (http://localhost:5103).
    /// </summary>
    [TestClass]
    public partial class MvcAuthenticationTest : AuthenticationTestBase
    {
        ...
        public async Task Authentication()
        {
            ...
            await this.Page.GotoAsync("http://localhost:5103/");
            ...
            await this.Page.WaitForURLAsync("http://localhost:5103/");
